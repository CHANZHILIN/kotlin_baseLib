package com.kotlin_baselib.gestureDetector;
...
/**
 * @Description:集成GestureDetector、ScaleGestureDetector，方便识别常用手势（点击、双击、长按、缩放等），并对特定场景下的手势识别进行优化 (ScaleGestureDetector使用了Android Api 27的源码)
 * @Author: CHEN
